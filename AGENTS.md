...
- Build from `/Users/dev/git/loop-state-machine.spec/explanation` with `npm run build`.
- Deploy the built output in `/Users/dev/git/loop-state-machine.spec/explanation/dist` with:
